...
const DIAGNOSIS_MITIGATIONS: Array<{ label: string; mitigations: string[] }> = [
  { label: 'نقص الموارد البشرية (فريق صغير أو غير متخصّص)', mitigations: ['توثيق الأدوار وتمكين التغطية المتبادلة لتقليل التبعيّة الفرديّة', 'خطّة توظيف/إسناد تدريجيّة حسب الأولويّة', 'الاستعانة بمصادر خارجيّة للمهام غير الجوهريّة'] },
  { label: 'قيود مالية (ميزانية محدودة أو تكاليف مرتفعة)', mitigations: ['ترتيب المصروفات بالأولويّة وإيقاف غير الجوهريّ', 'ميزانيّة تُبرّر كلّ بند (Zero-based)', 'بدائل منخفضة الكلفة/أدوات مجانيّة للمهام الثانويّة'] },
  { label: 'عمليات غير مؤتمتة (اعتماد يدوي مفرط)', mitigations: ['أتمتة أعلى ٣ مهام تكراريّة استنزافاً أوّلاً', 'توحيد إجراء تشغيل (SOP) قبل الأتمتة', 'أدوات سير عمل (Workflow) تربط الخطوات اليدويّة'] },
  { label: 'نقص البيانات لاتخاذ القرار', mitigations: ['تحديد ٣–٥ مؤشّرات قرار وجمعها دوريّاً', 'مصدر بيانات موحّد بدل جداول متفرّقة', 'لوحة متابعة بسيطة تُحدَّث تلقائيّاً'] },
  { label: 'ضعف التعاون مع الإدارات الأخرى', mitigations: ['اجتماع تنسيق دوريّ قصير بين الإدارات', 'مصفوفة مسؤوليّات (RACI) تحسم التداخل', 'قناة/أداة تشارك موحّدة للطلبات المشتركة'] },
  { label: 'ضغط الوقت والأولويات المتغيّرة', mitigations: ['أولويّات أسبوعيّة واضحة (Eisenhower)', 'حماية وقتٍ للمهام الجوهريّة من المقاطعات', 'تفويض/تأجيل المهام منخفضة القيمة'] },
  { label: 'قيود تنظيمية أو امتثال معقّد', mitigations: ['سجلّ متطلّبات تنظيميّة + مسؤول متابعة', 'مراجعة امتثال دوريّة قبل التفتيش', 'تحديث السياسات عند تغيّر الأنظمة'] },
  { label: 'التدفق المالي / السيولة اليومية', mitigations: ['مراجعة يوميّة/أسبوعيّة للتدفّق النقديّ', 'احتياطي نقديّ + خطّ ائتمان احتياطيّ', 'تسريع التحصيل وتنظيم مواعيد السداد'] },
  { label: 'التعيينات والتوظيف', mitigations: ['بناء pipeline مرشّحين مسبقاً', 'برنامج ترشيح داخليّ (Referral)', 'توثيق الأدوار لتسريع الإحلال'] },
  { label: 'سلسلة التوريد أو الإمداد', mitigations: ['تأهيل مورّد ثانٍ لكلّ صنف حرج', 'مخزون أمان للأصناف الحرجة', 'اتّفاقيّات مستوى خدمة (SLA) مع الموردين'] },
  { label: 'الأنظمة التقنية / السيرفرات', mitigations: ['نسخ احتياطيّة آليّة + خطّة تعافٍ', 'مراقبة توفّر (uptime) وتنبيهات مبكّرة', 'صيانة دوريّة وتحديثات أمان'] },
  { label: 'خدمة العملاء / الدعم', mitigations: ['اتّفاقيّة مستوى خدمة (SLA) لزمن الردّ', 'قاعدة معرفة وحلول ذاتيّة', 'قياس رضا (CSAT) ومعالجة المنخفض'] },
  { label: 'المبيعات والتسويق', mitigations: ['تنويع قنوات الاكتساب وقياس ROI', 'تحسين قمع البيع ومعدّل التحويل', 'متابعة العملاء المحتملين بانتظام'] },
  { label: 'الأمن السيبراني والبيانات', mitigations: ['مصادقة ثنائيّة + مبدأ الصلاحيّة الأدنى', 'نسخ احتياطيّة معزولة + خطّة استجابة', 'تحديثات أمان وتوعية الموظّفين'] },
  { label: 'تجديد التراخيص والاعتمادات', mitigations: ['سجلّ تراخيص مركزيّ بتواريخ الانتهاء', 'تنبيهات تجديد مبكّرة', 'مسؤول معيّن لكلّ ترخيص حرج'] },
  { label: 'التقارير الروتينية', mitigations: ['قوالب تقارير تُولَّد آليّاً من المصدر', 'جدولة إرسال دوريّ تلقائيّ', 'لوحة حيّة بدل تقارير يدويّة'] },
  { label: 'الرسائل والإشعارات المتكرّرة', mitigations: ['قوالب رسائل جاهزة', 'أتمتة الإشعارات حسب الحدث', 'تجميع الإشعارات لتقليل الضجيج'] },
  { label: 'إدخال البيانات اليدوي', mitigations: ['نماذج رقميّة تُغذّي النظام مباشرة', 'استيراد/تكامل بدل النسخ اليدويّ', 'تحقّق آليّ يقلّل الأخطاء'] },
  { label: 'الأرشفة وإدارة الملفات', mitigations: ['هيكلة تسمية ومجلّدات موحّدة', 'أرشفة آليّة حسب النوع/التاريخ', 'صلاحيّات وصول ونسخ احتياطيّة'] },
  { label: 'الموافقات والاعتمادات', mitigations: ['مسار موافقات إلكترونيّ متدرّج', 'حدود صلاحيّة تُسرّع القرارات الصغيرة', 'تتبّع حالة الطلب لتقليل التأخّر'] },
  { label: 'جدولة المواعيد والاجتماعات', mitigations: ['أداة حجز ذاتيّ للمواعيد', 'تقويم مشترك + تذكيرات آليّة', 'قوالب اجتماعات بأجندة محدّدة'] },
  { label: 'المراجعات الدورية', mitigations: ['قوائم تحقّق (Checklists) موحّدة', 'جدولة مراجعات آليّة + تذكير', 'توثيق النتائج ومتابعة الإجراءات'] },
  { label: 'إعداد الفواتير والمطالبات', mitigations: ['إصدار فواتير آليّ من النظام', 'تذكير تحصيل تلقائيّ', 'ربط الفوترة بالمدفوعات للمطابقة'] },
]

const DIAG_BY_NORM = new Map(DIAGNOSIS_MITIGATIONS.map((d) => [normalizeArabic(d.label), d.mitigations]))

// تخفيفات بند تشخيص مستورد — تطابق label مضبوط بعد التطبيع (normalizeArabic ينزع
// بادئة «[تشخيص]» تلقائيّاً). المصدر الأدقّ للمخاطر المستوردة.
export function diagnosisMitigations(name: string): string[] | undefined {
  return DIAG_BY_NORM.get(normalizeArabic(name))
}
