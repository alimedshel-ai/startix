...
/**
 * Bare-chrome printable view of a saved report. No sidebar, no topbar — opens
 * in a new tab and the user uses the browser's "Print → Save as PDF" flow.
 */
export function ReportPrintPage() {
  ...
  useEffect(() => {
    if (report) {
      // Tiny delay so the layout paints first
